...
bot.onText(/\/start/, async (msg) => {
  ...
  await bot.sendMessage(chatId, `Welcome back, ${user.firstName}. Your Shadow is watching…`);
...
bot.onText(/\/trophies/, async (msg) => {
  ...
  if (trophiesSnap.empty) {
    await bot.sendMessage(chatId, `🕯 You have yet to earn your marks. Your Shadow waits...`);
    return;
  }
